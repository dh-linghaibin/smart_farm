...
public class HorizontalNumProgressBar extends ProgressBar {
    public static final int PROGRESS_REACHED_COLOR = 0xFF42a5f6;
    public static final int PROGRESS_UNREACHED_COLOR = 0xFFb1d5f2;
...
//            leftLineW = realW - textW;
        ...
        mPaint.setAntiAlias(true);
        canvas.drawLine(0, centerH, rightLineW, centerH, mPaint);
