package com.jt28.a6735.mirro.movelayout;
        ...
        if (drager) {
            viewDragHelper = ViewDragHelper.create(this, 1.0f, new ViewDragHelper.Callback() {
                ...
                public void onViewReleased(View releasedChild, float xvel, float yvel) {
                    if("one".equals((String) releasedChild.getTag())) {
                        SharedPreferencesUtil.saveData(mContext,(String) releasedChild.getTag(), left_l + "#" + top_l);

                        if(left_l > 820) {
                            SharedPreferencesUtil.saveData(mContext, "tow", left_l - 1200 + "#" + top_l);
                        } else {
                            SharedPreferencesUtil.saveData(mContext, "tow", left_l + 700 + "#" + top_l);
                        }

                        Log.d("lhb", String.valueOf(left_l));
