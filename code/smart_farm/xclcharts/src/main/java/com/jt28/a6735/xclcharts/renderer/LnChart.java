...
import com.jt28.a6735.xclcharts.common.CurveHelper;
import com.jt28.a6735.xclcharts.common.MathHelper;
import com.jt28.a6735.xclcharts.common.PointHelper;
...
public class LnChart extends AxesChart {
	...
	public LnChart() {
		this.mBarCenterStyle = XEnum.BarCenterStyle.TICKMARKS;
		// 初始化图例
		if (null != plotLegend) {
			plotLegend.show();
